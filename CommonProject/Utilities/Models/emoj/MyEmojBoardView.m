...
- (UIButton *)delBtn{
    if (!_delBtn) {
        ...
        [_delBtn setImage:[UIImage imageNamed:@"chat_face_delete"] forState:UIControlStateNormal];
        [_delBtn setImage:[UIImage imageNamed:@"chat_face_delete_pressed"] forState:UIControlStateHighlighted];
