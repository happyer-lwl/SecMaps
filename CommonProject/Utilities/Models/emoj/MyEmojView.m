...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i=0; i<2; i++) {
            MyEmojBoardView* boardView = [MyEmojBoardView viewWithPage:i frame:CGRectMake(i*_boardWidth, 0, _boardWidth, CHAT_EMOJ_VIEW_H-CHAT_EMOJ_VIEW_PAGE_CNTL_H)];
...
//        self.emojPageControll.frame = CGRectMake(0, CGRectGetHeight(self.frame)-CHAT_EMOJ_VIEW_PAGE_CNTL_H, CGRectGetWidth(self.frame), CHAT_EMOJ_VIEW_PAGE_CNTL_H);
        self.emojPageControll.frame = CGRectMake(0, CHAT_EMOJ_VIEW_H-CHAT_EMOJ_VIEW_PAGE_CNTL_H, _boardWidth, CHAT_EMOJ_VIEW_PAGE_CNTL_H);
    }
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (page - 1 >= 0 && [self.emojScrollView viewWithTag:[MyEmojBoardView viewTagWithPage:page-1]] == nil) {
        MyEmojBoardView* boardView = [MyEmojBoardView viewWithPage:page-1 frame:CGRectMake((page-1)*_boardWidth, 0, _boardWidth, CHAT_EMOJ_VIEW_H-CHAT_EMOJ_VIEW_PAGE_CNTL_H)];
